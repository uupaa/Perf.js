...
})("Perf", function moduleClosure(global) {
"use strict";

// --- dependency modules ----------------------------------
var Clock = global["WebModule"]["Clock"];
...
function Perf(options) { // @arg Object - { parentNode, x, y, color, bgcolor, opacity }
    ...
    this._clock   = new Clock([], { "vsync": false, "wait": 1000, "start": true });
    ...
    placeholder.innerHTML = _format(
        '<div id="PERF_BOX" style="position:absolute;opacity:@;background-color:@;left:@px;top:@px;width:128px;height:64px">' +
...
Perf["VERBOSE"] = true;
Perf["repository"] = "https://github.com/uupaa/Perf.js";
